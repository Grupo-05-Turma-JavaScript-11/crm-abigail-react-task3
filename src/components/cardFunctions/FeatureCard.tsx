...
function FeatureCard({ feature }: FeatureCardProps) {
  return (
    <div
      className="bg-white p-8 rounded-2xl border border-[#9AEBA3]/30 shadow-sm 
                    hover:shadow-xl hover:border-[#45C4B0] transition-all duration-300 
                    flex flex-col items-start group text-justify"
    >
      <div
        className="p-3 rounded-lg bg-[#F8FAFC] text-[#025959] mb-5 
