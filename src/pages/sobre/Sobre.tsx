            ...
            <section className="w-full px-6 lg:px-20">
                ...
                <div className="grid gap-10 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-[#9AEBA3]/90 max-w-full text-justify">
                            Do prontuário eletrônico com IA ao relacionamento humanizado com o paciente, o CRM Abgail é um software médico completo para seus objetivos como médico.
                        </p>
                ...
                <section className="mt-12 grid gap-8 lg:grid-cols-3">
                    <div className="col-span-2 bg-white/3 rounded-2xl p-8 text-justify">
                        <h2 className="text-[1.4rem] font-bold text-white">Como o CRM Abgail ajuda sua clínica</h2>
                        <p className="mt-3 text-[1rem] text-white/90">
                            Desenvolvido a partir de fluxos clínicos reais, o CRM Abgail integra agenda, prontuário e comunicação com o paciente em uma única interface.
                            A plataforma oferece módulos independentes, permitindo que a clínica utilize apenas os recursos necessários, como gestão administrativa, atendimento,
                            prontuário com inteligência artificial e relatórios clínicos.
                        </p>

                        <div className="mt-6 grid gap-4 sm:grid-cols-2">
                            <div className="p-4 bg-white/5 rounded-lg">
                                <h4 className="font-semibold text-[#45C4B0]">Prontuário Inteligente</h4>
                                <p className="text-white/80 text-sm">Sugestões contextuais e resumos automatizados que aceleram a tomada de decisão.</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-lg">
                                <h4 className="font-semibold text-[#45C4B0]">Agenda e Fluxo</h4>
                                <p className="text-white/80 text-sm">Agendamento simples, fila de espera e histórico de atendimentos por paciente.</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-lg">
                                <h4 className="font-semibold text-[#45C4B0]">Comunicação</h4>
                                <p className="text-white/80 text-sm">Mensagens e lembretes com templates inteligentes e histórico centralizado.</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-lg">
                                <h4 className="font-semibold text-[#45C4B0]">Segurança & Compliance</h4>
                                <p className="text-white/80 text-sm">Auditoria de eventos, controle de acesso e criptografia de dados clínicos.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <aside className="p-4 bg-white/4 rounded-2xl flex flex-col space-y-3 w-fit mx-auto lg:mx-0">
                        <div>
                            ...
                            <p className="mt-1 text-white/80 text-[1rem] leading-tight max-w-full text-justify">
                                Impacto prático e mensurável no dia a dia da clínica, com menos tarefas administrativas, equipes mais sincronizadas e pacientes mais satisfeitos.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-1.5 w-full items-stretch">
                            <div className="bg-white/6 rounded-lg p-2 text-center flex flex-col h-[100px] min-w-[85px]">
                                <div className="font-bold text-white text-lg leading-none">30%</div>
                                ...
                                <div className="mt-auto pt-2">
                                    <div className="h-2 w-[76px] mx-auto bg-white/10 rounded-full overflow-hidden">
                                        <div
                                            ...
                                            style={{ width: "30%", background: "linear-gradient(90deg,#45C4B0,#9AEBA3)" }}
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/6 rounded-lg p-2 text-center flex flex-col h-[100px] min-w-[85px]">
                                <div className="font-bold text-white text-lg leading-none">18%</div>
                                ...
                                <div className="mt-auto pt-2">
                                    <div className="h-2 w-[76px] mx-auto bg-white/10 rounded-full overflow-hidden">
                                        <div
                                            className="h-full rounded-full"
                                            style={{ width: "18%", background: "linear-gradient(90deg,#027333,#45C4B0)" }}
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/6 rounded-lg p-2 text-center flex flex-col h-[100px] min-w-[85px]">
                                <div className="font-bold text-white text-lg leading-none">25%</div>
                                ...
                                <div className="mt-auto pt-2">
                                    <div className="h-2 w-[76px] mx-auto bg-white/10 rounded-full overflow-hidden">
                                        <div
                                            className="h-full rounded-full"
                                            style={{ width: "25%", background: "linear-gradient(90deg,#025959,#45C4B0)" }}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-white/90">
                            <li className="flex items-start gap-2">
                                <svg className="w-4 h-4 text-[#45C4B0] flex-shrink-0" viewBox="0 0 24 24" fill="none" aria-hidden>
                        ...
                        <div className="mt-4">
                            <p className="text-sm text-white/70">Quer ver em ação? Agende uma demonstração personalizada.</p>
                            <a
                                href="/demo"
                    ...
                    <div className="grid gap-8 lg:grid-cols-3 text-justify">
                        <div className="space-y-3">
                            ...
                            <p className="text-white/90">
                                Empoderar clínicas e profissionais da saúde por meio de um software que organiza processos, otimiza o tempo médico e
                                eleva a experiência do paciente, garantindo segurança, clareza e confiabilidade em cada etapa do atendimento.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-white/90">
                                Tornar-se o CRM de referência para clínicas brasileiras, unindo cuidado clínico, tecnologia escalável e o
                                uso ético da inteligência artificial como apoio à decisão e à gestão em saúde.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="list-disc pl-5 text-white/90 space-y-1">
                                ...
                                <li>Respeito à rotina médica, às necessidades do paciente e à complexidade do atendimento em saúde</li>
                ...
                <section className="mt-12">
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-white/80 text-sm p-2">Profissionais multidisciplinares unidos pelo cuidado.</p>
                    </div>
                    ...
                    <div className="mt-6 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-justify">
                        {team.map((m) => (
                            ...
                            >
                                <img src={m.img} alt={m.name} className="w-16 h-16 rounded-full object-cover ring-2 ring-[#45C4B0]/40" />
                                <div>
                ...
                <section className="mt-12 bg-[#012340]/60 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div>
                        <h3 className="text-xl font-bold text-white">Pronto para transformar o atendimento da sua clínica?</h3>
                        <p className="text-white/80 mt-2 text-sm">Converse com nossa equipe e descubra como o CRM Abgail pode se encaixar no seu fluxo.</p>
                    </div>

                    <div className="flex gap-3">
                        <a href="/contato" className="inline-flex items-center gap-2 bg-[#45C4B0] text-[#012340] px-5 py-3 rounded-lg font-semibold hover:brightness-95 transition">
                            Agendar conversa
                        </a>
                        <a href="/roadmap" className="inline-flex items-center gap-2 border border-white/20 px-5 py-3 rounded-lg hover:bg-white/5 transition">
                            Ver roadmap
                        </a>
                    </div>
                </section>
