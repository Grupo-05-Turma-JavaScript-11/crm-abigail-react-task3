      ...
      <div className="w-full max-w-4xl bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-white border-b px-8 py-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-500 text-sm">Preencha os dados para criar o prontuário.</p>
          </div>
          <button 
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Observações */}
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-gray-700 mb-1">Observações Médicas</label>
              <textarea
